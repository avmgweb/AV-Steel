                                ...
                                ?>
									<div class="product-item-detail-info-container" data-entity="sku-line-block">
										<div class="product-item-scu-item-text-block table-title"><?
                                            foreach ($arResult["OFFERS"]["0"]["DISPLAY_PROPERTIES"] as  $key => $val2) {
                                                if($key != "CML2_LINK"){
                                                    echo("<div class='product-item-scu-item-text'>" . $val2["NAME"] . "</div>");
                                                }
                                            }
                                            echo("<div class='product-item-scu-item-text'>" . $arResult["OFFERS"]["0"]["CATALOG_GROUP_NAME_1"] . "</div>");
